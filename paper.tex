...
At 7B, CF90 also reduced the 3-gram repetition rate from 40.3\% to 24.9\%, the opposite of the quality degradation seen at 0.5B.
This confirms that the repetition problem is a consequence of insufficient model capacity, not an inherent limitation of the method.
